...
export default class Radio extends Component {
  ...
  render() {
    ...
    return (<div ref={(el) => {this.$el = el}} {...others} onClick={(e) => {onClick(e, e.target.getAttribute('data-checked') === 'true')}} data-checked={checked} data-value={value} className={`radio${others.className ? ' ' + others.className : ''}`}>
