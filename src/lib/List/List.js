...
export default class List extends Component {
  ...
  onClick = (e) => {
    ...
    if (classList.contains('licon') && onClickLicon) {
      onClickLicon(Object.getArgs(e, this.props.args));
      e.stopPropagation();
    } else if (classList.contains('ricon') && onClickRicon) {
      onClickRicon(Object.getArgs(e, this.props.args));
      e.stopPropagation();
    } else if (classList.contains('list-rcaption') && onClickRcaption) {
      onClickRcaption(Object.getArgs(e, this.props.args));
      e.stopPropagation();
    } else if (onClick){
  ...
  onClickContainer = (e) => {
    if (this.props.onClickContainer) {
      this.props.onClickContainer(Object.getArgs(e, this.props.args));
      e.stopPropagation();
    }
  }
  onClickThumbnail = (e) => {
    if (this.props.onClickThumbnail) {
      this.props.onClickThumbnail(Object.getArgs(e, this.props.args));
      e.stopPropagation();
    }
  }
  onClickAvatar = (e) => {
