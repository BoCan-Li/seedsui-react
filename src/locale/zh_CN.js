export default {
  ...
  'hint_upload_video_must_dir': '没有上传目录',
  'hint_upload_video_must_localIds': '没有上传视频地址',
  'hint_upload_video_must_tenantId': '没有上传企业id',
  'hint_preview_video_must_urls': '没有预览视频地址',
