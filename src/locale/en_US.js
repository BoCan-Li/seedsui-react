export default {
  ...
  'hint_upload_video_must_dir': 'Upload video failed for no dir',
  'hint_upload_video_must_localIds': 'Upload video failed for no localIds',
  'hint_upload_video_must_tenantId': 'Upload video failed for no tenantId',
  'hint_preview_video_must_urls': 'Upload video failed for no urls',
  'hint_video_record_version': 'Video recording function needs to be upgraded to 6.2.2 and above clients',
  'hint_video_record_failed': 'Recording failed',
  'hint_video_upload_version': 'The video upload function needs to be upgraded to 6.2.2 and above clients',
  'hint_video_upload_failed': 'Video upload failed',
  ...
  'hint_get_customer_area_more_version': 'This feature needs to be upgraded to 6.2.2 and above clients',
  'hint_open_native_page_must_ios_url': 'This feature needs to be upgraded to 6.2.2 and above clients',
  'hint_open_native_page_must_android_url': 'This feature needs to be upgraded to 6.2.2 and above clients',
