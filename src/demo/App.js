  ...
  render() {
    ...
    return <Page style={{ backgroundColor: 'white' }}>
      ...
      <Container>
        ...
        <Jcrop src={srcData} onChange={this.onChange} style={{width: '200px'}}/>
        <Handsign/>
      </Container>
    </Page>
  }
