...
export default class App extends Component {
  ...
  render() {
    ...
    return <Page style={{ backgroundColor: 'white' }}>
      ...
      <Container>
        <MenuTree list={list} style={MenuTreeStyle} onClick={this.onClick} onScroll={this.onScrollMenu} activeId={this.state.value}/>
      </Container>
    </Page>
  }
};
