...
export default class App extends Component {
  ...
  render() {
    ...
    return <Page style={{ backgroundColor: 'white' }}>
      ...
      <Container>
				<Tree ref={(el) => {this.$tree = el}} list={groupList} activeId={activeMenuId} onClick={this.onClickMenu} onData={this.onData}/>
      </Container>
    </Page>
  }
};
