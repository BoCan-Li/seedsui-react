...
var ListPull = function (_Component) {
  ...
  function ListPull(props) {
    ...
    return (0, _possibleConstructorReturn3.default)(this, (ListPull.__proto__ || (0, _getPrototypeOf2.default)(ListPull)).call(this, props));
  }
    ...
    value: function componentDidMount() {
      ...
      var instance = new _instance2.default(this.$el, {
        onClick: function onClick(e) {
          ...
          var item = _this2.props.list[index];
          var btn = null;
          ...
          if (_this2.props.onClick) _this2.props.onClick(item, index, btn);
        },
...
ListPull.propTypes = {
  list: _propTypes2.default.array, // [{container: node, lButtons: [{value: '按钮文字', className: 'warn', style: object}], rButtons: 同lButtons}]
