...
var Bridge = {
  ...
  // 文件是否存在
  isExistsFile: function isExistsFile() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  // 外勤附件转为base64
  wqUrlToBase64: function wqUrlToBase64() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var callback = arguments[1];
  ...
  */
  Image: function Image() {
    ...
    s.choose = function () {
      ...
      if (!Bridge.debug) {
        if (params.onChooseError) params.onChooseError({ code: 'chooseFail', msg: '拍照功能只能在APP或者微信中使用' });else Bridge.showToast('拍照功能只能在APP或者微信中使用', { mask: false });
        return;
      }
      var option = {
