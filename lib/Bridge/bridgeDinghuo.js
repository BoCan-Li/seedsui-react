...
var Bridge = {
  ...
  */
  ...
  /**
    ...
    * @param {Function} callback 回调
    */
  setTitle: function setTitle(params, callback) {
  ...
  /**
    ...
    * @param {Function} callback 回调
    */
  onHistoryBack: function onHistoryBack(callback) {
    this.invoke('onHistoryBack', null, callback);
  },
  // ios客户端返回按钮绑定, ios不支持addBackPress
  addIosBackPress: function addIosBackPress(callback) {
    var _this = this;

    this.onHistoryBack(function () {
      if (callback) callback();else if (_this.back) _this.back();
      _this.addIosBackPress(callback);
    });
  },
  /**
    * 分享文本
    ...
    * @param {Function} callback 回调
    */
  shareText: function shareText(params, callback) {
  ...
  /**
    ...
    */
  getIdentification: function getIdentification(callback) {
  ...
  */
  ...
  updateSystemParameter: function updateSystemParameter(callback) {
    ...
    this.loginInfo(function (loginData) {
      _this3.systemParameter(function (sysData) {
        var data = {};
        ...
        _this3.setSystemParameter(data);
