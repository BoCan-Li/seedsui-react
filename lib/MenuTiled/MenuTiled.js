...
var MenuTiled = function (_Component) {
  ...
  function MenuTiled(props) {
    ...
    _this.shouldComponentUpdate = function (nextProps) {
      if (!nextProps.list || !_this.props.list || _this.props.list.length === nextProps.list.length) {
        return false;
      }
      return true;
    };
  ...
  (0, _createClass3.default)(MenuTiled, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          list = _props.list,
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'activeId', 'onClick', 'list']);

      return _react2.default.createElement('div', (0, _extends3.default)({ ref: function ref(el) {
          _this2.$el = el;
        }, className: 'menutiled' + (className ? ' ' + className : '') }, others));
    }
  }]);
  return MenuTiled;
}(_react.Component);
