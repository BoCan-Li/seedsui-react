...
var InputSelect = function (_Component) {
  ...
  function InputSelect(props) {
    ...
    _this.onClickSubmit = function (selected) {
      if (!_this.$input) _this.$input = _this.refs.$ComponentInputText.$input;
      if (_this.props.onClickSubmit) {
        _this.props.onClickSubmit(selected);
        return;
      }
      var value = _this.getValue(selected);
      // 赋值
      ...
      if (_this.props.onChange) {
        _this.props.onChange(value, selected, _this.props.args);
      }
    };
  ...
  (0, _createClass3.default)(InputSelect, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['valueForKey', 'split', 'list', 'multiple', 'onClick', 'onChange', 'pickerStyle', 'pickerClassName', 'pickerMaskStyle', 'pickerMaskClassName', 'pickerShow', 'onClickSubmit', 'onClickCancel', 'onClickMask']);
