...
var Tree = function (_Component) {
  ...
  function Tree(props) {
    ...
    _this.componentDidUpdate = function (prevProps) {
      if (_this.props.list && _this.props.list.length && (0, _stringify2.default)(prevProps.list) !== (0, _stringify2.default)(_this.props.list)) {
    ...
    _this.onClick = function (s) {
      ...
      var item = list.getFlattenTreeNode(id);
      // isActived
      ...
      // isExtend
      var isExtend = s.targetLine.classList.contains('extend');
...
Tree.propTypes = {
  ...
  multiple: _propTypes2.default.bool, // 是否需要多选
  checkbox: _propTypes2.default.bool, // 是否可选
