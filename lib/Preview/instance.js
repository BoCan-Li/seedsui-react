...
var _pinchZoom = require('./pinch-zoom.js');

var _pinchZoom2 = _interopRequireDefault(_pinchZoom);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Preview = function Preview(params) {
  /* ----------------------
  Model
  ---------------------- */
  var defaults = {
  ...
  s.update = function () {
    ...
    img.addEventListener('load', function () {
      ...
      // PinchZoom
      s.PinchZoom = new _pinchZoom2.default(s.container, {
        onZoomUpdate: function onZoomUpdate() {
          if (s.clickTimeout) {
  ...
  s.onClick = function () {
    ...
    s.clickTimeout = window.setTimeout(function () {
      if (s.params.onClick) s.params.onClick(s);else s.hide();
    }, s.params.clickDelay);
  };
  s.onClickBack = function () {
    if (s.params.onClickBack) s.params.onClickBack(s);else s.hide();
  };
  // 主函数
  s.init = function () {
    s.attach();
