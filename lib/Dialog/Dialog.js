  ...
  (0, _createClass3.default)(Dialog, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['portal', 'args', 'maskClassName', 'maskStyle', 'isClickMaskHide', 'onClickMask', 'onShowed', 'onHid', 'duration', 'show', 'className', 'style', 'animation', 'children']);
      ...
      return (0, _reactDom.createPortal)(_react2.default.createElement(
        ...
        (0, _extends3.default)({ ref: function ref(el) {
            _this2.$el = el;
          }, className: 'mask dialog-mask' + (maskClassName ? ' ' + maskClassName : '') + (show ? ' active' : ''), style: (0, _assign2.default)(duration !== undefined ? { WebkitTransitionDuration: duration + 'ms' } : {}, maskStyle), onClick: this.onClickMask }, others),
