  ...
  (0, _createClass3.default)(Notice, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'style', 'wrapperParams', 'icon', 'caption', 'captionParams', 'sndcaption', 'sndcaptionParams', 'children']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          icon ? icon : _react2.default.createElement('i', { className: 'icon notice-icon notice-icon-nodata' }),
