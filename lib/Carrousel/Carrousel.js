  ...
  function Carrousel(props) {
    ...
    _this.componentDidMount = function () {
      ...
      if (!(_this.props.style && _this.props.style.height) && _this.props.list.length && _this.props.delay) {
        setTimeout(function () {
          _this.state.instance.updateContainerSize();
        }, _this.props.delay);
      }
    };
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          list.length > 0 && list.map(function (item, index) {
            return _react2.default.createElement(
              'div',
              { className: 'carrousel-slide' + (slideClassName ? ' ' + slideClassName : '') + (item.bg ? ' carrousel-lazy' : ''), style: _this2.getSlideStyle(item), key: index, 'data-load-src': item.bg },
...
Carrousel.propTypes = {
  ...
  stopPropagation: _propTypes2.default.bool, // 是否阻止点击事件的传播, 解决与fastclick事件冲突的问题
