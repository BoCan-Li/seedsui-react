  ...
  (0, _createClass3.default)(Progress, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['style', 'className', 'barStyle', 'barClassName', 'percentage', 'max', 'min', 'value', 'showPercentage']);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          showPercentage && _react2.default.createElement(_Counter2.default, { duration: 1000, to: textPercentage, from: 0, suffix: '%', style: { fontSize: '12px', marginRight: '4px' } }),
