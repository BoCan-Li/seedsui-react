...
var InputDate = function (_Component) {
  ...
  function InputDate(props) {
    ...
    _this.correctDate = function (value) {
      ...
      var selectDate = Date.parse(text, type);
  ...
  (0, _createClass3.default)(InputDate, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['valueBindProp', 'min', 'max', 'type', 'pickerStyle', 'pickerClassName', 'onClick', 'onChange', 'onError']);
