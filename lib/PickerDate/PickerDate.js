...
var PickerDate = function (_Component) {
  ...
  function PickerDate(props) {
    ...
    _this.setDefault = function () {
      ...
      _this.instance.setDefaults(def);
    ...
    _this.getDefault = function () {
      ...
      var defaultValue = _this.props.valueForKey || _this.props.value;
      var now = new Date();
      ...
      if (type === 'date') {
        ...
        if (!defaultValue || !new RegExp('^[0-9]{4}' + (split || '-') + '[0-9]{2}' + (split || '-') + '[0-9]{2}$').test(defaultValue)) {
          ...
          var dateValues = defaultValue.split(_this.props.split);
        ...
        if (!defaultValue || !new RegExp('^[0-9]{4}' + (split || '-') + '[0-9]{2}$').test(defaultValue)) {
          ...
          var monthValues = defaultValue.split(_this.props.split);
        ...
        if (!defaultValue || !new RegExp('^[0-9]{4}' + (split || '-') + '[0-9]{2}' + (split || '-') + '[0-9]{2}\\s[0-9]{2}:[0-9]{2}(:[0-9]{2})?$').test(defaultValue)) {
          ...
          var _dateValues = values[0].split(_this.props.split);
