  ...
  function Attributes(props, context) {
      ...
      if (item.price) {
        ...
        return _react2.default.createElement(
          ...
          { key: 'button' + index, style: item.buttonStyle, className: item.buttonClassName, onClick: function onClick(e) {
              e.stopPropagation();if (item.buttonClick) item.buttonClick(item.buttonArgs || '');
            } },
          buttonValue
        );
        // html
    ...
    _this.getOpDOM = function (item, index) {
      ...
      if (item.copy) {
        ...
        return _react2.default.createElement(
          _Button2.default,
          { key: index, className: 'ricon sm', style: { borderRadius: '3px' }, args: copyValue, onClick: _this.onCopyToClipboard },
          '\u590D\u5236'
        );
      }
      // 电话
    ...
    value: function render() {
      ...
      var _loop = function _loop(_i) {
        if (col === '2') {
          attrsDOM.push(_react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                list[_i].ricon && _react2.default.createElement(
                  'span',
                  null,
                  list[_i].ricon
                )
            ...
            list[_i + 1] && _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                list[_i + 1].ricon && _react2.default.createElement(
                  'span',
                  null,
                  list[_i + 1].ricon
                )
          ...
          if (list[_i].show !== undefined) isShow = list[_i].show;
          if (isShow) {
            attrsDOM.push(_react2.default.createElement(
              'div',
              { key: 'row' + _i, className: _this2.getRowClassName(), style: rowStyle, onClick: function onClick() {
...
Attributes.propTypes = {
  ...
  col: _propTypes2.default.string, // 列数, 默认1
