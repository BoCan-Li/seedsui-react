...
var Marquee = function (_Component) {
  ...
  function Marquee(props) {
    ...
    _this.componentDidMount = function () {
      if (_this.state.instance || _this.props.list.length === 0) return;
      _this.init();
    };

    _this.update = function () {
      _this.state.instance.setStart(0);
      _this.state.instance.setEnd(_this.props.step * (_this.props.list.length - 1));
      _this.state.instance.update();
      _this.state.instance.play();
    };
