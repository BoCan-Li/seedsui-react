  ...
  function InputText(props) {
    ...
    _this.getInputDOM = function () {
      var _this$props3 = _this.props,
          ...
          rcaption = _this$props3.rcaption,
          ...
          others = (0, _objectWithoutProperties3.default)(_this$props3, ['args', 'style', 'className', 'onClick', 'max', 'min', 'digits', 'onChange', 'onClickInput', 'onBlur', 'onFocus', 'liconClassName', 'riconClassName', 'onClickLicon', 'onClickRicon', 'clearClassName', 'clear', 'rcaption', 'pre', 'type', 'valueBindProp', 'autoFocus', 'inputClassName', 'inputStyle', 'maxLength', 'value', 'placeholder', 'name', 'readOnly', 'disabled']);
      // pre类型
      ...
      if (type === 'textarea') {
        ...
        if (valueBindProp) {
          return _react2.default.createElement('textarea', (0, _extends3.default)({ autoFocus: autoFocus, ref: function ref(el) {
              _this.$input = el;
            }, value: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, name: name, onChange: _this.onChange, onClick: _this.onClickInput, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-area' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
        }
        return _react2.default.createElement('textarea', (0, _extends3.default)({ autoFocus: autoFocus, ref: function ref(el) {
            _this.$input = el;
          }, defaultValue: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, name: name, onInput: _this.onChange, onClick: _this.onClickInput, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-area' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
      }
      // 其它类型
      var inputType = type;
      switch (type) {
      ...
      if (valueBindProp) {
        return _react2.default.createElement('input', (0, _extends3.default)({ autoFocus: autoFocus, ref: function ref(el) {
            _this.$input = el;
          }, type: inputType, value: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, name: name, onChange: _this.onChange, onClick: _this.onClickInput, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-text' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
      }
      return _react2.default.createElement('input', (0, _extends3.default)({ autoFocus: autoFocus, ref: function ref(el) {
          _this.$input = el;
        }, type: inputType, defaultValue: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, name: name, onInput: _this.onChange, onClick: _this.onClickInput, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-text' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
    };
  ...
  (0, _createClass3.default)(InputText, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        liconClassName && _react2.default.createElement(_Icon2.default, { className: 'licon ' + liconClassName, onClick: this.onClickLicon }),
        this.getInputDOM(),
        clear && _react2.default.createElement(_Close2.default, { onClick: this.onClear, className: '' + (isShowClear ? '' : 'hide') + (clearClassName ? ' ' + clearClassName : '') }),
        riconClassName && _react2.default.createElement(_Icon2.default, { className: 'ricon ' + riconClassName, onClick: this.onClickRicon }),
        rcaption && rcaption
      );
    }
  }]);
