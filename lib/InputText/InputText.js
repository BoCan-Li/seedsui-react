  ...
  function InputText(props) {
    ...
    _this.onChange = function (e) {
      ...
      if (type === 'phone') {
        ...
        value = Math.Calc.correctNumber(value, _this.props);
      }
      // onChange
      if (type !== 'text') {
    ...
    _this.onBlur = function (e) {
      ...
      if (_this.props.type === 'number') {
        ...
        value = Math.Calc.correctNumberBlur(value, { required: required, min: min });
        if (onChange) onChange(value, _this.getArgs(e));
    ...
    _this.onClear = function (e) {
      ...
      if (_this.props.clear && typeof _this.props.clear === 'function') _this.props.clear(e);
