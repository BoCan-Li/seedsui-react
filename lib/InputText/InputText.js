...
var InputText = function (_Component) {
  ...
  function InputText(props) {
    ...
    _this.componentDidUpdate = function (prevProps) {
      if (prevProps.readOnly !== _this.props.readOnly || prevProps.disabled !== _this.props.disabled) {
    ...
    _this.onChange = function (e) {
      ...
      if (!valueBindProp) _this.updateShowClear(value);
    };
    ...
    _this.onClear = function (e) {
      ...
      e.stopPropagation();
      // 非valueBindProp时, 更新清除按钮状态
      if (!valueBindProp) _this.updateShowClear('');
    };

    _this.getInputDOM = function () {
      var _this$props7 = _this.props,
          args = _this$props7.args,
          style = _this$props7.style,
          className = _this$props7.className,
          onClick = _this$props7.onClick,
          onChange = _this$props7.onChange,
          onClickInput = _this$props7.onClickInput,
          onBlur = _this$props7.onBlur,
          onFocus = _this$props7.onFocus,
          max = _this$props7.max,
          min = _this$props7.min,
          digits = _this$props7.digits,
          licon = _this$props7.licon,
          onClickLicon = _this$props7.onClickLicon,
          ricon = _this$props7.ricon,
          onClickRicon = _this$props7.onClickRicon,
          clear = _this$props7.clear,
          clearClassName = _this$props7.clearClassName,
          clearStyle = _this$props7.clearStyle,
          rcaption = _this$props7.rcaption,
          pre = _this$props7.pre,
          ...
          others = (0, _objectWithoutProperties3.default)(_this$props7, ['args', 'style', 'className', 'onClick', 'onChange', 'onClickInput', 'onBlur', 'onFocus', 'max', 'min', 'digits', 'licon', 'onClickLicon', 'ricon', 'onClickRicon', 'clear', 'clearClassName', 'clearStyle', 'rcaption', 'pre', 'type', 'valueBindProp', 'autoFocus', 'inputClassName', 'inputStyle', 'maxLength', 'value', 'placeholder', 'readOnly', 'disabled']);
      // pre类型
      ...
      if (valueBindProp) {
        ...
        return _react2.default.createElement('input', (0, _extends3.default)({ max: max, min: min, autoFocus: autoFocus, ref: function ref(el) {
            _this.$input = el;
          }, type: type, value: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, onChange: _this.onChange, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-text' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
      }
      return _react2.default.createElement('input', (0, _extends3.default)({ max: max, min: min, autoFocus: autoFocus, ref: function ref(el) {
          _this.$input = el;
        }, type: type, defaultValue: value, maxLength: maxLength, readOnly: readOnly, disabled: disabled, placeholder: placeholder, onChange: _this.onChange, onBlur: _this.onBlur, onFocus: _this.onFocus, className: 'input-text' + (inputClassName ? ' ' + inputClassName : ''), style: inputStyle }, others));
    };

    _this.updateShowClear = function (value) {
      var _this$props8 = _this.props,
          readOnly = _this$props8.readOnly,
          disabled = _this$props8.disabled,
          clear = _this$props8.clear,
          valueBindProp = _this$props8.valueBindProp;
...
InputText.propTypes = {
  type: _propTypes2.default.string, // 类型: text, number, tel, password
