...
var InputText = function (_Component) {
  ...
  function InputText(props) {
    ...
    _this.onChange = function (e) {
      ...
      if (_this.props.clear) {
        ...
        if (!valueBindProp) {
          if (_this.$input) isShowClear = _this.$input.value.length > 0;
        } else {
    ...
    _this.getInputDOM = function () {
      ...
      if (pre) {
        ...
        return _react2.default.createElement(
          ...
          valueBindProp && _react2.default.createElement('textarea', { autoFocus: autoFocus, ref: function ref(el) {
              _this.$input = el;
      ...
      if (type === 'textarea') {
        ...
        if (valueBindProp) {
          return _react2.default.createElement('textarea', { autoFocus: autoFocus, ref: function ref(el) {
              _this.$input = el;
      ...
      // 如果值绑定属性,则只有通过父组件的prop来改变值
      if (valueBindProp) {
        return _react2.default.createElement('input', { autoFocus: autoFocus, ref: function ref(el) {
            _this.$input = el;
  ...
  (0, _createClass3.default)(InputText, [{
    ...
    value: function render() {
      ...
      var isShowClear = this.state.isShowClear;
