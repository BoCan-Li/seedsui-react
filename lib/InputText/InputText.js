...
var InputText = function (_Component) {
  ...
  function InputText(props) {
    ...
    _this.onBlur = function (e) {
      ...
      if (onBlur) {
        onBlur(value, Object.getArgs(e, _this.props.args));
      }
    };
    ...
    _this.getInputDOM = function () {
      var _this$props4 = _this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_this$props4, ['args', 'style', 'className', 'onClick', 'max', 'min', 'digits', 'onChange', 'onClickInput', 'onBlur', 'onFocus', 'licon', 'onClickLicon', 'ricon', 'onClickRicon', 'clear', 'clearClassName', 'clearStyle', 'rcaption', 'pre', 'type', 'valueBindProp', 'autoFocus', 'inputClassName', 'inputStyle', 'maxLength', 'value', 'placeholder', 'readOnly', 'disabled']);
      // pre类型
