...
var Handsign = function Handsign(container, params) {
  ...
  s.onTouchStart = function (e) {
    ...
    s.stageInfo = s.container.getBoundingClientRect();
    s.ctx.beginPath();
    s.ctx.moveTo(e.changedTouches[0].clientX - s.stageInfo.left, e.changedTouches[0].clientY - s.stageInfo.top);
    s.path.beginX = e.changedTouches[0].clientX - s.stageInfo.left;
    s.path.beginY = e.changedTouches[0].clientY - s.stageInfo.top;
  };
  s.onTouchMove = function (e) {
    e.stopPropagation();
    s.ctx.lineTo(e.changedTouches[0].clientX - s.stageInfo.left, e.changedTouches[0].clientY - s.stageInfo.top);
