...
var PickerCity = function (_Component) {
  ...
  function PickerCity(props) {
    ...
    _this.setDefault = function () {
      var valueForKeys = _this.props.valueForKeys;

      if (Array.isArray(valueForKeys) && valueForKeys.length > 1) {
        _this.state.instance.setDefaultKeys(valueForKeys);
      } else {
        var defaultValues = _this.getDefaultValues();
        _this.state.instance.setDefaultValues(defaultValues);
      }
    ...
    _this.getDefaultKeys = function () {
      if (Array.isArray(_this.props.valueForKeys) && _this.props.valueForKeys.length > 1) {
        return _this.props.valueForKeys;
      }
      return ['', '', ''];
    };
...
PickerCity.propTypes = {
  ...
  valueForKeys: _propTypes2.default.array,
