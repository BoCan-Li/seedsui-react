  ...
  (0, _createClass3.default)(NumBoxPop, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['args', 'caption', 'value', 'onClickCancel', 'onClickSubmit']);

      return _react2.default.createElement(
        _Alert2.default,
        { args: args, ref: function ref(el) {
            _this2.$el = el;
          }, duration: 0, caption: caption, show: true, onClickSubmit: this.onClickSubmit, onClickCancel: this.onClickCancel },
