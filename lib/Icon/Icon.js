  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['style', 'baseClassName', 'defaultImgClassName', 'defaultImgStyle', 'className', 'src', 'lazyLoad', 'children', 'badgeCaption', 'badgeClassName', 'badgeStyle', 'badgeLimit', 'badgeEllipsis']);
      ...
      return _react2.default.createElement(
        ...
        lazyLoad && src && _react2.default.createElement('span', { className: 'icon-img ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src }),
        !lazyLoad && src && _react2.default.createElement('span', { className: 'icon-img ' + defaultImgClassName, style: (0, _assign2.default)({ backgroundImage: 'url(' + src + ')' }, defaultImgStyle) }),
        children,
