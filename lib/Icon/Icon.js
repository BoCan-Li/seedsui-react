...
var Icon = function (_Component) {
  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      if (base === 'pureImg') {
        if (src && lazyLoad) {
          return _react2.default.createElement('img', { alt: '', className: 'icon-truth icon-img ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src });
        }
        if (src && !lazyLoad) {
          return _react2.default.createElement('img', { alt: '', className: 'icon-truth icon-img ' + defaultImgClassName, style: defaultImgStyle, src: src });
        }
        return null;
      }
      if (base === 'pureIcon') {
      ...
      return _react2.default.createElement(
        ...
        src && base === 'icon' && lazyLoad && _react2.default.createElement('span', { className: 'icon-truth icon-full ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src }),
        src && base === 'icon' && !lazyLoad && _react2.default.createElement('span', { className: 'icon-truth icon-full ' + defaultImgClassName, style: (0, _assign2.default)({ backgroundImage: 'url(' + src + ')' }, defaultImgStyle) }),
        src && base === 'img' && lazyLoad && _react2.default.createElement('img', { alt: '', className: 'icon-truth icon-img ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src }),
        src && base === 'img' && !lazyLoad && _react2.default.createElement('img', { alt: '', className: 'icon-truth icon-img ' + defaultImgClassName, style: defaultImgStyle, src: src }),
        children,
