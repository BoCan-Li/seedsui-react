  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['style', 'baseClassName', 'defaultImgClassName', 'className', 'src', 'lazyLoad', 'children', 'badgeCaption', 'badgeClassName', 'badgeStyle', 'badgeLimit', 'badgeEllipsis']);
      ...
      return _react2.default.createElement(
        ...
        lazyLoad && src && _react2.default.createElement('span', { className: 'icon-img ' + defaultImgClassName, 'data-load-src': src }),
        !lazyLoad && src && _react2.default.createElement('span', { className: 'icon-img ' + defaultImgClassName, style: { backgroundImage: 'url(' + src + ')' } }),
        children,
