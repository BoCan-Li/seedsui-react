  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['style', 'className', 'src', 'lazyLoad', 'children', 'badgeCaption', 'badgeClassName', 'badgeStyle', 'badgeLimit', 'badgeEllipsis']);
      ...
      return _react2.default.createElement(
        ...
        (0, _extends3.default)({ ref: function ref(el) {
            _this2.$el = el;
          }, className: 'icon' + (nodataIconClassName ? ' ' + nodataIconClassName : '') + (className ? ' ' + className : ''), style: newStyle }, others),
