  ...
  (0, _createClass3.default)(Icon, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        src && base === 'icon' && lazyLoad && _react2.default.createElement('span', { className: 'icon-full ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src }),
        src && base === 'icon' && !lazyLoad && _react2.default.createElement('span', { className: 'icon-full ' + defaultImgClassName, style: (0, _assign2.default)({ backgroundImage: 'url(' + src + ')' }, defaultImgStyle) }),
        src && base === 'img' && lazyLoad && _react2.default.createElement('img', { alt: '', className: 'icon-img ' + defaultImgClassName, style: defaultImgStyle, 'data-load-src': src }),
        src && base === 'img' && !lazyLoad && _react2.default.createElement('img', { alt: '', className: 'icon-img ' + defaultImgClassName, style: defaultImgStyle, src: src }),
        children,
