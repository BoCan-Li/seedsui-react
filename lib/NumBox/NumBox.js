...
var NumBox = function (_Component) {
  ...
  function NumBox(props) {
    ...
    _this.onBlur = function (e) {
      ...
      if (onChange && '' + value !== '' + _this.props.value) onChange(value, _this.getArgs(e));
    ...
    _this.getInputDOM = function () {
      var _this$props3 = _this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_this$props3, ['args', 'style', 'className', 'disabled', 'onClick', 'plusStyle', 'plusClassName', 'minusStyle', 'minusClassName', 'onClickMinus', 'onClickPlus', 'licon', 'liconSrc', 'liconClassName', 'liconStyle', 'onClickLicon', 'liconLazyLoad', 'ricon', 'riconSrc', 'riconClassName', 'riconStyle', 'onClickRicon', 'riconLazyLoad', 'clear', 'clearClassName', 'clearStyle', 'inputStyle', 'inputClassName', 'value', 'placeholder', 'maxLength', 'readOnly', 'onClickInput', 'onChange', 'onError', 'onBlur', 'onFocus', 'digits', 'max', 'min']);
