  ...
  function NumBox(props) {
    ...
    _this.getInputDOM = function () {
      var _this$props4 = _this.props,
          ...
          plusStyle = _this$props4.plusStyle,
          plusClassName = _this$props4.plusClassName,
          minusStyle = _this$props4.minusStyle,
          minusClassName = _this$props4.minusClassName,
          onClickMinus = _this$props4.onClickMinus,
          onClickPlus = _this$props4.onClickPlus,
          ...
          others = (0, _objectWithoutProperties3.default)(_this$props4, ['args', 'style', 'className', 'disabled', 'onClick', 'plusStyle', 'plusClassName', 'minusStyle', 'minusClassName', 'onClickMinus', 'onClickPlus', 'licon', 'liconSrc', 'liconClassName', 'liconStyle', 'onClickLicon', 'liconLazyLoad', 'ricon', 'riconSrc', 'riconClassName', 'riconStyle', 'onClickRicon', 'riconLazyLoad', 'clear', 'clearClassName', 'clearStyle', 'inputStyle', 'inputClassName', 'value', 'placeholder', 'maxLength', 'readOnly', 'onClickInput', 'onChange', 'onError', 'onBlur', 'onFocus', 'digits', 'max', 'min', 'autoFocus', 'autoSelect']);
