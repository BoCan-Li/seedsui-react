...
var NumBox = function (_Component) {
  ...
  function NumBox(props) {
    ...
    _this.onBlur = function (e) {
      e.target.value = _this.props.value;
    };
    ...
    _this.onChange = function (e) {
      var value = _this.correctNum(e.target.value);
      if (_this.props.onChange) _this.props.onChange(value, _this.getArgs(e));
    };

    _this.onClickMinus = function (e) {
      var value = _this.correctNum(Math.Calc.subtract(_this.$input.value, 1));
      // Callback
      if (_this.props.onChange) _this.props.onChange(value, _this.getArgs(e));
    ...
    _this.onClickPlus = function (e) {
      var value = _this.correctNum(Math.Calc.add(_this.$input.value, 1));
      // Callback
      if (_this.props.onChange) _this.props.onChange(value, _this.getArgs(e));
