...
(function () {
  ...
  GeoUtil.polygonToLines = function (polygon, isRegular) {
    ...
    if (isRegular) {
      lines.push([polygon[polygon.length - 1][0], polygon[polygon.length - 1][1], polygon[0][0], polygon[0][1]]);
    }
    return lines;
  };
  ...
  GeoUtil.lineIntersectLine = function (line0, line1) {
    var _line = (0, _slicedToArray3.default)(line0, 4),
        a = _line[0],
        b = _line[1],
        c = _line[2],
        d = _line[3];

    var _line2 = (0, _slicedToArray3.default)(line1, 4),
        p = _line2[0],
        q = _line2[1],
        r = _line2[2],
        s = _line2[3];
