...
// PagePull 侧边栏
var PagePull = function PagePull(container, params) {
  /* ------------------------
  Model
  ------------------------ */
  var defaults = {
    ...
    sideLeftClass: 'aside-left',
    sideRightClass: 'aside-right',
  ...
  s.mask = s.createMask();
  s.main.appendChild(s.mask);
  // Aside
  s.sides = { 'left': null, 'right': null };
  s.position = null;
  s.update = function () {
  ...
  s.onTransitionEnd = function (e) {
    ...
    // Callback
    /*if(e.target===s.wrapper || e.target===s.main || e.target.getAttribute('data-transition')){
        s.target=e.target
