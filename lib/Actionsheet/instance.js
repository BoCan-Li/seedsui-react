...
// Actionsheet
var Actionsheet = function Actionsheet(params) {
  /* ------------------
  Model
  ------------------ */
  var defaults = {
  ...
  s.createGroup = function () {
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(s.params.data.entries()), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
