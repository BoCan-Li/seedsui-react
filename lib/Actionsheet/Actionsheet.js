...
var Actionsheet = function (_Component) {
  ...
  function Actionsheet(props) {
    ...
    _this.onClickCancel = function (e) {
      if (_this.props.onClickCancel) _this.props.onClickCancel(_this.getArgs(e));
      e.stopPropagation();
    };
  ...
  (0, _createClass3.default)(Actionsheet, [{
    ...
    value: function render() {
      ...
      return (0, _reactDom.createPortal)(_react2.default.createElement(
        ...
        { ref: function ref(el) {
            _this2.$el = el;
          }, className: 'mask actionsheet-mask' + (maskClassName ? ' ' + maskClassName : '') + (show ? ' active' : ''), style: (0, _assign2.default)(duration !== undefined ? { WebkitTransitionDuration: duration + 'ms' } : {}, maskStyle), onClick: this.onClickMask },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            list && list.map(function (item, index) {
              return _react2.default.createElement(
                'a',
                { className: 'actionsheet-option' + (optionClassName ? ' ' + optionClassName : ''), style: optionStyle, key: index, 'data-index': index, onClick: _this2.onClick },
                item.caption
              );
            })
          ),
          onClickCancel && _react2.default.createElement(
            'a',
            { className: 'actionsheet-cancel' + (cancelClassName ? ' ' + cancelClassName : ''), style: cancelStyle, onClick: this.onClickCancel },
            cancelCaption
          )
        )
