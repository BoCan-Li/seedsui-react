...
var InputLocationMap = function (_Component) {
  (0, _inherits3.default)(InputLocationMap, _Component);

  function InputLocationMap(props) {
    (0, _classCallCheck3.default)(this, InputLocationMap);

    var _this = (0, _possibleConstructorReturn3.default)(this, (InputLocationMap.__proto__ || (0, _getPrototypeOf2.default)(InputLocationMap)).call(this, props));
    ...
    _this.onClick = function (value, args) {
      ...
      _Bridge2.default.getLocationMap({
  ...
  (0, _createClass3.default)(InputLocationMap, [{
