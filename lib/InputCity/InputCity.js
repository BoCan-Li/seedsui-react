  ...
  (0, _createClass3.default)(InputCity, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['data', 'dataKeyPropertyName', 'dataValuePropertyName', 'dataChildPropertyName', 'valueForKey', 'split', 'type', 'pickerStyle', 'pickerClassName', 'onClick', 'onChange', 'pickerShow', 'onClickSubmit', 'onClickCancel', 'onClickMask']);
