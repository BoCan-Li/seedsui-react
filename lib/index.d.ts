...
export { default as InputPre } from './InputPre';
export { default as InputRange } from './InputRange';  // 不常用
export { default as InputSafe } from './InputSafe'; // 不常用
export { default as InputSelect } from './InputSelect';
export { default as InputStar } from './InputStar';
export { default as InputText } from './InputText';
// export { default as Jcrop } from './Jcrop'; // 不常用,裁切功能,需要引入jcrop插件
