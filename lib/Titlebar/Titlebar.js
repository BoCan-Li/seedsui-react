      ...
      return arr.map(function (item, index) {
        if (item === '$back') {
          item = {
            ...
            iconStyle: _this.props.backIconStyle || null,
        ...
        return _react2.default.createElement(
          ...
          (item.iconSrc || item.iconClassName) && _react2.default.createElement('span', { className: 'icon' + (item.iconClassName ? ' ' + item.iconClassName : ''), style: item.iconSrc ? { backgroundImage: 'url(' + item.iconSrc + ')' } : {} }),
          item.icon && item.icon,
