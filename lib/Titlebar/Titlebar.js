  ...
  (0, _createClass3.default)(Titlebar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'showUrlTitle', 'caption', 'captionClassName', 'captionStyle', 'children', 'onClickCaption', 'lButtons', 'rButtons', 'onClickBack']);
      ...
      var title = caption;
      if (showUrlTitle) {
        title = _Device2.default.getUrlParameter('title', location.search) || caption;
      }
...
Titlebar.propTypes = {
  ...
  showUrlTitle: _propTypes2.default.bool, // 标题是否显示url中的title
