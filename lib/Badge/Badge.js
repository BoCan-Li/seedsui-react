  ...
  (0, _createClass3.default)(Badge, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'style', 'children', 'limit', 'ellipsis']);
      // 标题
      ...
      return _react2.default.createElement(
        ...
        (0, _extends3.default)({ ref: function ref(el) {
            _this2.$el = el;
          }, className: 'badge' + (autoWidthClass ? ' ' + autoWidthClass : '') + (className ? ' ' + className : ''), style: style }, others),
        caption
      );
    }
  }]);
