...
Object.params = function (obj, splitter, isNotEnCode) {
  ...
  if (splitter === 'dot') {
    var arr = [];
    for (var n in obj) {
      arr.push(n + '=' + (0, _stringify2.default)(obj[n]));
    }
    return arr.join('&');
  }
...
Object.extend = function () {
  ...
  if ((typeof target === 'undefined' ? 'undefined' : (0, _typeof3.default)(target)) !== 'object' && !Object.isFunction(target)) {
    target = {};
  }
...
Object.equals = function (object1, object2) {
  ...
  for (var propName in object1) {
    ...
    // 检查实例类型
    else if ((0, _typeof3.default)(object1[propName]) !== (0, _typeof3.default)(object2[propName])) {
        // 不同的类型=>不等于
        return false;
      }
  }
