...
var Timeline = function (_Component) {
  ...
  (0, _createClass3.default)(Timeline, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'timeline' + (className ? ' ' + className : ''), style: style },
        _react2.default.createElement('span', { className: 'timeline-line' + (lineClassName ? ' ' + lineClassName : ''), style: lineStyle }),
        listDOM
      );
    }
  }]);
