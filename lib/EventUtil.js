...
var EventUtil = function () {
  /**
    ...
    */
  var _countClickEventHandler = function _countClickEventHandler(e) {
    // 解析参数
  ...
  var _countClickEvent = function _countClickEvent(element, type, handler, isDetach, params) {
    // 构建参数
    element.prevCount = 0;
  ...
  /**
    ...
    */
  var _touchEvent = function _touchEvent(element, type, handler, isDetach) {
    var params = {
      threshold: 0
      /* ------------------------
      Model
  ...
  var _shakeEventHandler = function _shakeEventHandler(e) {
  ...
  var _shakeEvent = function _shakeEvent(element, type, handler, isDetach) {
  ...
  /**
    ...
    */
  return {
    addHandler: function addHandler(element, type, handler, params) {
