  ...
  (0, _createClass3.default)(InputVerify, [{
    ...
    value: function render() {
      var _props = this.props,
          _props$digits = _props.digits,
          digits = _props$digits === undefined ? 0 : _props$digits,
          sentDisabled = _props.sentDisabled,
          sentCaption = _props.sentCaption,
          onClickSent = _props.onClickSent,
          others = (0, _objectWithoutProperties3.default)(_props, ['digits', 'sentDisabled', 'sentCaption', 'onClickSent']);

      return _react2.default.createElement(_InputNumber2.default, (0, _extends3.default)({ ref: '$ComponentInputText' }, others, { type: 'number', digits: digits, rcaption: [_react2.default.createElement('span', { className: 'splitter', key: 'rsentsplitter' }), _react2.default.createElement(
          'a',
