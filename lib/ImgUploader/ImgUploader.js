...
var ImgUploader = function (_Component) {
  ...
  function ImgUploader(props) {
    ...
    _this.componentDidMount = function () {
      ...
      _this.setState({
        instance: new _Bridge2.default.Image({
          onChooseSuccess: _this.onChooseSuccess,
          onUploadsSuccess: _this.onUploadsSuccess,
          onUploadFail: _this.onUploadFail
        })
      });
    };
    ...
    _this.convertList = function (imgMap) {
      ...
      } else if (_Bridge2.default.platform === 'weixin') {
    ...
    _this.onChange = function (imgMap) {
      ...
      // 显示和隐藏添加按钮
      if (list.length >= _this.props.max) {
        _this.setState({
          showUpload: false
        });
      } else {
    ...
    _this.onChooseSuccess = function (imgMap) {
      _this.onChange(imgMap);
    };

    _this.onUploadFail = function (index) {
      // 删除上传错误的一项
    ...
    _this.onUploadsSuccess = function (imgMap) {
      _this.onChange(imgMap);
    };
  ...
  (0, _createClass3.default)(ImgUploader, [{
    ...
    value: function render() {
      ...
      return [caption && _react2.default.createElement(
        'div',
        { key: 'iuCaption', className: 'grid-title' + (captionClassName ? ' ' + captionClassName : ''), style: captionStyle },
        caption,
      ...
      ), _react2.default.createElement(_Grid2.default, { onClickDelete: this.props.showDelete ? this.deleteImg : null, onClickAdd: this.chooseImg, list: list, showUpload: this.state.showUpload && this.props.showUpload, showDelete: showDelete, key: 'iuGrid', className: 'grid-album' + (className ? ' ' + className : ''), wing: 12, space: 12, style: style })];
    }
  }]);
  return ImgUploader;
}(_react.Component);
