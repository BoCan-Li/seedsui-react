  ...
  function ImgUploader(props) {
    ...
    _this.chooseImg = function () {
      var _this$props = _this.props,
          ...
          chooseOptions = _this$props.chooseOptions;
  ...
  (0, _createClass3.default)(ImgUploader, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'style', 'caption', 'captionStyle', 'captionClassName', 'list', 'enableSafe', 'max', 'sourceType', 'sizeType', 'showUpload', 'showDelete', 'readOnly', 'showCount', 'chooseOptions', 'onChange', 'onChooseSuccess', 'onUploadsSuccess', 'onDeleteSuccess']);
