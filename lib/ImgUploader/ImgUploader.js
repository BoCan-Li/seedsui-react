  ...
  (0, _createClass3.default)(ImgUploader, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['className', 'style', 'caption', 'captionStyle', 'captionClassName', 'list', 'enableSafe', 'max', 'sourceType', 'sizeType', 'showUpload', 'showDelete', 'readOnly', 'showCount', 'watermark', 'onChange', 'onChooseSuccess', 'onUploadsSuccess', 'onDeleteSuccess']);
