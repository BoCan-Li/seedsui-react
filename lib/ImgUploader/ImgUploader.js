  ...
  function ImgUploader(props) {
    ...
    _this.componentDidMount = function () {
      ...
      _this.instance = new _Bridge2.default.Image({
        ...
        onChooseError: _this.props.onChooseError,
    ...
    _this.uploadSuccess = function (imgMap) {
      _this.onChange(imgMap, { op: 'uploadSuccess' });
      if (_this.props.onUploadSuccess) _this.props.onUploadSuccess(_this.convertList(imgMap));
    };

    _this.uploadFail = function (imgMap, err) {
      _this.onChange(imgMap, (0, _assign2.default)({ op: 'uploadFail' }, err));
      if (_this.props.onUploadFail) _this.props.onUploadFail(_this.convertList(imgMap), err);
    };

    _this.chooseImg = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var allowChoose, _this$props, enableSafe, max, sourceType, sizeType, chooseOptions;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 6:
              _this$props = _this.props, enableSafe = _this$props.enableSafe, max = _this$props.max, sourceType = _this$props.sourceType, sizeType = _this$props.sizeType, chooseOptions = _this$props.chooseOptions;
...
ImgUploader.propTypes = {
  ...
  onChooseError: _propTypes2.default.func, // 照片选择错误
