...
var Emoji = function (_Component) {
  ...
  function Emoji(props) {
    ...
    _this.componentDidUpdate = function (prevProps) {
      // 自动获取焦点
      if (_this.props.autoFocus && prevProps.show !== _this.props.show && _this.props.show === true && _this.$inputPre) {
  ...
  (0, _createClass3.default)(Emoji, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['show', 'data', 'portal', 'args', 'autoFocus', 'value', 'placeholder', 'isClickMaskHide', 'onClickMask', 'maskClassName', 'maskStyle', 'className', 'style', 'licon', 'onChange', 'submitCaption', 'submitStyle', 'submitClassName', 'onClickSubmit']);

      return (0, _reactDom.createPortal)(_react2.default.createElement(
        'div',
        { ref: function ref(el) {
            _this2.$el = el;
          }, className: 'mask emoji-mask' + (show ? ' active' : '') + (maskClassName ? ' ' + maskClassName : ''), style: maskStyle, onClick: this.onClickMask },
        _react2.default.createElement(
          'div',
          { ref: function ref(el) {
              _this2.$container = el;
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { className: 'emoji-edit-submit' + (submitClassName ? ' ' + submitClassName : ''), style: submitStyle, disabled: !value },
              submitCaption
            )
          ),
          _react2.default.createElement(
...
Emoji.propTypes = {
  show: _propTypes2.default.bool, // ios内核必须隐藏, 不能移除dom, 弹出时才不会有bug, 所以必须用show
