  ...
  function Grid(props) {
    ...
    _this.onClickIcon = function (e, item, index) {
      if (_this.props.onClickIcon) {
        _this.props.onClickIcon(item, index, Object.getArgs(e, _this.props.args));
        e.stopPropagation();
      }
    };
    ...
    _this.onClickIconBox = function (e, item, index) {
      if (_this.props.onClickIconBox) {
        _this.props.onClickIconBox(item, index, Object.getArgs(e, _this.props.args));
        e.stopPropagation();
      }
      // 如果是视频则自带预览功能,不需要预览
      ...
      // 如果有点击事件,则不走预览
      if (item.onClick) {
        item.onClick(item, index, Object.getArgs(e, _this.props.args));
        e.stopPropagation();
        return;
      }
    ...
    _this.onClickCell = function (e, item, index) {
      ...
      if (_this.props.onClickCell) {
        _this.props.onClickCell(item, index, Object.getArgs(e, _this.props.args));
        e.stopPropagation();
      }
    };
    ...
    _this.onClickDelete = function (e, item, index) {
      if (_this.props.onClickDelete) {
        _this.props.onClickDelete(item, index, Object.getArgs(e, _this.props.args));
        e.stopPropagation();
      }
    };
    ...
    _this.onClickAdd = function (e) {
      if (_this.props.onClickAdd) {
        _this.props.onClickAdd(Object.getArgs(e, _this.props.args));
        e.stopPropagation();
      }
    };
      ...
      dom = _react2.default.createElement(
        ...
        showUpload === true && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            { onClick: function onClick(e) {
                _this2.onClickAdd(e);
              }, className: 'grid-iconbox grid-icon-add-box' + (iconBoxClassName ? ' ' + iconBoxClassName : ''), style: iconBoxStyle },
...
Grid.propTypes = {
  ...
  iconBase: _propTypes2.default.string,
