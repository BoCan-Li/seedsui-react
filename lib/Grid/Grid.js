        ...
        list.length > 0 && list.map(function (item, index) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              (item.iconSrc || item.iconClassName) && _react2.default.createElement(_Icon2.default, { lazyLoad: lazyLoad, badgeClassName: iconBadgeClassName, badgeCaption: item.iconBadgeCaption, defaultImgClassName: iconDefaultImgClassName, defaultImgStyle: iconDefaultImgStyle, onClick: function onClick(e) {
                  _this2.onClickIcon(e, item, index);
                }, className: 'grid-icon' + (iconClassName ? ' ' + iconClassName : '') + (item.iconClassName ? ' ' + item.iconClassName : ''), style: (0, _assign2.default)(iconStyle, item.iconStyle ? item.iconStyle : {}), src: item.iconSrc ? item.iconSrc : '' }),
