...
(function () {
  ...
  /**
    ...
    */
  GeoUtils.isPointInPolygon = function () {
    var argPoint = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var argPoints = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    ...
    try {
      for (var _iterator = (0, _getIterator3.default)(argPoints), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var po = _step.value;
