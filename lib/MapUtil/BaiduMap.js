...
var BaiduMap = function BaiduMap(id, params) {
  ...
  s.addContextMenu = function (overlay) {
    ...
    try {
      ...
      for (var _iterator2 = (0, _getIterator3.default)(options.menus.entries()), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        _loop();
      }
    } catch (err) {
