...
var Dragrefresh = function (_Component) {
  ...
  function Dragrefresh(props) {
    ...
    _this.componentDidUpdate = function (prevProps) {
      ...
      // 懒加载
      if (_this.props.lazyLoad) {
        if (!_this.lazyLoadInstance) {
          _this.setLazyLoad();
        } else {
          _this.lazyLoadInstance.load();
        }
      }
  ...
  (0, _createClass3.default)(Dragrefresh, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.hasMore === 404 && showNoData && _react2.default.createElement(_Notice2.default, (0, _extends3.default)({ caption: '暂无数据', iconParams: { className: 'notice-icon-nodata' } }, noDataParams))
      );
    }
  }]);
  return Dragrefresh;
