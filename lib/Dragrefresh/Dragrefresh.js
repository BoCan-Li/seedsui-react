...
var Dragrefresh = function (_Component) {
  ...
  function Dragrefresh(props) {
    ...
    _this.setPagination = function (prevHasMore, hasMore) {
      ...
      // 无数据时不允许触发刷新
      if (_this.props.showNoData && hasMore === 404) {
        _this.instance.detach();
      } else if (_this.props.showNoData && prevHasMore === 404 && hasMore !== 404) {
  ...
  (0, _createClass3.default)(Dragrefresh, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          bottomLoadingCaption = _props.bottomLoadingCaption,
          bottomNoDataCaption = _props.bottomNoDataCaption,
          bottomErrorCaption = _props.bottomErrorCaption,
          onClickBottomError = _props.onClickBottomError;
      ...
      return _react2.default.createElement(
        ...
        onTopRefresh && _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              window._seeds_lang['pull_down'] || '下拉可以刷新'
            )
          )
        ),
        this.props.children,
        ...
        onBottomRefresh && hasMore === -1 && _react2.default.createElement(
          'div',
          { className: 'SID-Dragrefresh-ErrorContainer df-pull', style: { height: '50px' }, onClick: onClickBottomError },
          _react2.default.createElement(
            'div',
            { className: 'df-pull-box' },
            _react2.default.createElement(
...
Dragrefresh.propTypes = {
  ...
  hasMore: _propTypes2.default.number, // hasMore: 0.无更多数据 1.数据加载完成 404.一条数据都没有 -1. 加载错误 -2. 重置状态,为了后面可以更新DOM
  ...
  // 底部加载中
  bottomLoadingCaption: _propTypes2.default.string,
  // 底部加载完成
  bottomNoDataCaption: _propTypes2.default.string,
  // 底部加载错误
  bottomErrorCaption: _propTypes2.default.string,
  onClickBottomError: _propTypes2.default.func
};
