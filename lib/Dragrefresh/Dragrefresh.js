  ...
  (0, _createClass3.default)(Dragrefresh, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        this.props.hasMore === 404 && showNoData && _react2.default.createElement(_Notice2.default, (0, _extends3.default)({ caption: '暂无数据', iconClassName: 'notice-icon-nodata' }, noDataParams))
      );
    }
  }]);
  return Dragrefresh;
