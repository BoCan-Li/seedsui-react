  ...
  (0, _createClass3.default)(NumBoxPopPointer, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          others = (0, _objectWithoutProperties3.default)(_props, ['args', 'className', 'style', 'numboxClassName', 'numboxStyle', 'value', 'disabled', 'min', 'max', 'digits', 'unitClassName', 'unitStyle', 'unit', 'onChange']);
      var show = this.state.show;

      return _react2.default.createElement(
        'div',
        (0, _extends3.default)({ style: (0, _assign2.default)({ position: 'relative' }, style), className: className }, others),
        ...
        _react2.default.createElement(_NumBoxPop2.default, {
          args: args,
          show: show,
          value: value,
          min: min,
